...
`)
	...
	testhelpers.WaitUntil(t, "both good rows committed", func() bool {
		var n int
...
`)
	...
	testhelpers.WaitUntil(t, "delete settles", func() bool {
		var n int
...
`)
	...
	testhelpers.WaitUntil(t, "compensation settles", func() bool {
		var n int
